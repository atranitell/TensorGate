...
from gate.net.custom import sens_fcn
...
class AVEC2014_AUDIO_FCN(context.Context):

  def __init__(self, config):
    context.Context.__init__(self, config)

  def _encoder(self, data):
    logit, z = sens_fcn.encoder(data, 1, self.is_training)
    return logit, z

  def _decoder(self, z):
    fake = sens_fcn.decoder(z, self.is_training)
    return fake
