...
class lfw(database.Database):
    ...
    def __init__(self, data_type, name, chkp_path=None):
        ...
        self.image.set_raw_size(250, 250)
    ...
    def _test(self):
        self.batch_size = 100
        self.total_num = 12000
        self.name = self.name + '_test'
        self.reader_thread = 1
        self.shuffle = False
        self.data_path = '../_datasets/lfw/test.txt'
    ...
    def _train(self):
        ...
        self.shuffle = True
        self.data_path = '../_datasets/lfw/train.txt'
