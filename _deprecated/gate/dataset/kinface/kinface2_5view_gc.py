...
class kinface2_5view_gc(database.Database):

    def loads(self):
        return data_loader.load_image_5view_gc_from_text(
    ...
    def __init__(self, data_type, name, chkp_path=None):
        ...
        self.image.set_raw_size(36, 36)
        self.image.set_output_size(32, 32)
        self.image.set_preprocessing('kinface')
    ...
    def _test(self):
        ...
        self.shuffle = False
        self.data_path = '../_datasets/kinface2_gc/val_1.txt'
    ...
    def _val(self):
        ...
        self.reader_thread = 1
        self.shuffle = False
        self.data_path = '../_datasets/kinface2_gc/train_1.txt'
