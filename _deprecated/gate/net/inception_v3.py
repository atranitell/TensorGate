...
from gate.net import inception_utils
...
class Inception_v3(net.Net):

    default_image_size = 224

    def arguments_scope(self):
        return inception_utils.inception_arg_scope(
            self.weight_decay,
            self.batch_norm_decay,
            self.batch_norm_epsilon)

    def model(self, images, num_classes, is_training):
        return inception_v3(images, num_classes, is_training,
