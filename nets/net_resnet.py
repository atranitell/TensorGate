...
# resnet_arg_scope = net_resnet_utils.resnet_arg_scope


class resnet50(net.Net):

    def model(self, images, num_classes, is_training):
        return resnet_v2_50(images, num_classes=num_classes, is_training=is_training)

    def arg_scope(self):
        return net_resnet_utils.resnet_arg_scope()


class resnet101(net.Net):

    def model(self, images, num_classes, is_training):
        return resnet_v2_101(images, num_classes=num_classes, is_training=is_training)

    def arg_scope(self):
        return net_resnet_utils.resnet_arg_scope()


class resnet152(net.Net):

    def model(self, images, num_classes, is_training):
        return resnet_v2_152(images, num_classes=num_classes, is_training=is_training)

    def arg_scope(self):
        return net_resnet_utils.resnet_arg_scope()


class resnet200(net.Net):

    def model(self, images, num_classes, is_training):
        return resnet_v2_200(images, num_classes=num_classes, is_training=is_training)
...
def bottleneck(inputs, depth, depth_bottleneck, stride, rate=1,
    ...
    with tf.variable_scope(scope, 'bottleneck_v2', [inputs]) as sc:
        ...
        if depth == depth_in:
            shortcut = net_resnet_utils.subsample(inputs, stride, 'shortcut')
        else:
