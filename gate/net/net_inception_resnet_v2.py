...
class inception_resnet_v2(net.Net):
    ...
    def arg_scope(self):
        return inception_resnet_v2_arg_scope(self.weight_decay,
                                             self.batch_norm_decay,
                                             self.batch_norm_epsilon)

    def model(self, images, num_classes, is_training):
        return inception_resnet_v2_net(images, num_classes, is_training, self.dropout_keep_prob)
...
def inception_resnet_v2_net(inputs, num_classes=1001, is_training=True,
