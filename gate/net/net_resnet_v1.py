...
Typical use:
   ...
   from tensorflow.contrib.layers.nets import resnet_v1
...
from gate.net import net_resnet_utils as resnet_utils


class resent_v1(net.Net):
    ...
    def bottleneck(self, inputs, depth, depth_bottleneck, stride, rate=1,
        ...
        with tf.variable_scope(scope, 'bottleneck_v1', [inputs]) as sc:
            ...
            if depth == depth_in:
                ...
                shortcut = layers.conv2d(inputs, depth, [1, 1], stride=stride,
...
class resnet_v1_50(resent_v1):
    ...
    def model(self,
        ...
        return self.resnet_v1(inputs, blocks, num_classes, is_training,
                              global_pool=global_pool, output_stride=output_stride,
                              include_root_block=True, reuse=reuse, scope=scope)


class resnet_v1_101(resent_v1):
