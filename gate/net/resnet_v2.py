...
from gate.net import resnet_utils
...
class Resnet_v2(net.Net):

    default_image_size = 224

    def arguments_scope(self):
        return resnet_arg_scope(self.weight_decay,
                                self.batch_norm_decay,
                                self.batch_norm_epsilon,
                                self.batch_norm_scale)


class Resnet_v2_50(Resnet_v2):

    def model(self, images, num_classes, is_training):
        return resnet_v2_50(
            images, num_classes, is_training,
            global_pool=True, output_stride=None,
            spatial_squeeze=True, reuse=self.reuse)


class Resnet_v2_101(Resnet_v2):

    def model(self, images, num_classes, is_training):
        return resnet_v2_101(
            images, num_classes, is_training,
            global_pool=True, output_stride=None,
            spatial_squeeze=True, reuse=self.reuse)


class Resnet_v2_152(Resnet_v2):

    def model(self, images, num_classes, is_training):
        return resnet_v2_152(
            images, num_classes, is_training,
            global_pool=True, output_stride=None,
            spatial_squeeze=True, reuse=self.reuse)


class Resnet_v2_200(Resnet_v2):

    def model(self, images, num_classes, is_training):
        return resnet_v2_200(
            images, num_classes, is_training,
            global_pool=True, output_stride=None,
            spatial_squeeze=True, reuse=self.reuse)
