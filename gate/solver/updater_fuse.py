...
class Updater_fuse():
    """ consider two network to fuse
        train_list_1 + train_list_2 = variable_to_train
    """

    def __init__(self, dataset, global_step, losses, train_list, exclusions=None, is_summary=True):
